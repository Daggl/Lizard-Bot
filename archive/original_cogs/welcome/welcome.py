...
VERIFY_CHANNEL_ID = _CFG.get("VERIFY_CHANNEL_ID", 1472473174313799803)
WELCOME_CHANNEL_ID = _CFG.get("WELCOME_CHANNEL_ID", 1471979239367774248)
RULES_CHANNEL_ID = _CFG.get("RULES_CHANNEL_ID", 1266609104005103617)
ABOUTME_CHANNEL_ID = _CFG.get("ABOUTME_CHANNEL_ID", 1266609208518774794)
ROLE_ID = _CFG.get("ROLE_ID", 1472417667670347817)
...
𝖻𝖾𝖿𝗈𝗋𝖾 𝗒𝗈𝗎 𝖿𝗅𝗈𝖺𝗍 𝖺𝗋𝗈𝗎𝗇𝖽 𝗍𝗁𝖾 𝗌𝖾𝗋𝖛𝖾𝗋,
...
❀ 𝗶𝗻𝘁𝗋𝗈𝗱𝘂𝗰𝗲 𝘆𝗈𝘂𝗋𝘀𝗲𝗹𝗳 ❀
𝖼𝗋𝗎𝗂𝗌𝖾 𝗈𝗏𝖾𝗋 𝗍𝗈 {aboutme_channel.mention} 𝖺𝗇𝖽 𝗍𝖾𝗅𝗅 𝗎𝗌 𝗆𝗈𝗋𝖾 𝖺𝖻𝗈𝗎𝖳 𝗒𝗈𝗎!
𝗐𝖾 𝗐𝖺𝗇𝗍 𝗍𝗈 𝗄𝗇𝗈𝗐 𝗐𝗁𝗈 𝗒𝗈𝗎 𝖺𝗋𝗂 𝖻𝖾𝖿𝗈𝗋𝖾 𝗐𝖾 𝖺𝖽𝗈𝗉𝗍 𝗒𝗈𝗎

❀ 𝗮𝗳𝘁𝗲𝗋 𝘆𝗈𝘂 𝗁𝗮𝘃𝗘 𝗰𝗈𝗆𝗉𝗅𝗘𝗍𝗘𝗗 𝗔𝗅𝗅 𝗍𝗁𝗘 𝗙𝗈𝗋𝗆𝗔𝗅𝗂𝗍𝗂𝗘𝗌 ❀
