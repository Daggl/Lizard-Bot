...
TICKET_CATEGORY_ID: Optional[int] = 1270347714931986485
SUPPORT_ROLE_ID: Optional[int] = 1266608353421955153
TICKET_LOG_CHANNEL_ID: Optional[int] = 1473793741197148250
...
class TicketCog(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot) -> None:
        self.bot = bot
        ensure_dir("data/logs/tickets")
        # SQLite DB for tickets
        self.db_path = os.path.join("data", "logs", "tickets", "tickets.db")
    ...
    async def save_transcript(self, channel: discord.TextChannel) -> Optional[str]:
        ...
        try:
            ensure_dir("data/logs/tickets")
            path = os.path.join("data/logs/tickets", f"{channel.id}.txt")
            messages = []
